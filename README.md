# Bioblog
A question was asked. What is information science? hwat are biological systems? What is biology? Last what does it mean for these to be quantified? 

Furthermore, are there methods for deriving quantities from biological systems? Is it even possible to quantify their growth or behavior? Could quantification bring clarity to biological systems?

This README describes areas of ongoing Biological Research. Where, applied discrete mathematics is beneficial to the analysis and categorization of tissue.

Bioblog Blog was initiated as an Open Source archive for Applied Biological Research. 
The intent being that research could influence and provide suitable answers to the questions which were asked.

From an inofrmation perspective, there was an intent to utilize different Sensor architectures: including Nuclear Magnetic Resonance, X-Ray, Computed Tomography or even Ultrasound.

Discrete Systems are apparent in the formulation of Biological and Chemical processes.
Even in an algebraic, or algorithmic sense, being able to represent these
processes symbolically simplifies their modeling and simulation.
